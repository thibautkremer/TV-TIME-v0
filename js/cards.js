'use strict';
// ============================================================
// CARDS — Rendu complet avec overlays et gestion cohérente
// ============================================================
...
function createMediaCard(media, isLib = false) {
    ...
    // Barre de progression (uniquement si en bibliothèque)
    let progressBar = '';
    if (isLib || libItem) {
        const prog = getProgress(libItem || media);
    ...
    div.innerHTML = `
        ...
        <div class="p-2 flex flex-col flex-1">
            ${progressBar}
            <h3 class="font-bold text-white text-[10px] truncate leading-tight mt-1" title="${media.title_fr || media.title}">${media.title_fr || media.title}</h3>
