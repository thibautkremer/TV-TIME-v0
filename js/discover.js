...
async function renderDiscoverTab(isAppend = false) {
    ...
    if (currentDiscoverMode === 'top') {
        ...
        // Logique "Pour Vous" (mix) intelligente basée sur vos genres
        const genreCounts = {};
        ...
        if (topGenreId) extraParams += `&with_genres=${topGenreId}`;
